...
Hyderabad circuit.
When he is not debating, you can find him playing or watching football. Ali believes the most
important part of a conference is to learn and gain new experiences.
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-sky-500/10 to-blue-500/10 backdrop-blur-xl rounded-2xl p-8 border border-sky-400/20 shadow-xl">
            ...
            <div className="flex justify-center">
              <a
                href="/committees/ccpcj/background-guide.pdf"
                download
